...
if __name__ == "__main__":
    ...
    bot_token_secret_name = "price-bots/graviaura-bot-token"
    # key value to retrieve secret value after boto3 call to secretsmanager
    bot_token_secret_key = "BOT_TOKEN_GRAVIAURA"

    badger_client = PriceBot(
        coingecko_token_id="gravitationally-bound-aura",
        token_display="graviAURA",
        discord_id=os.getenv("BOT_ID_GRAVIAURA"),
